        ...
        <div class="col-md-12 col-lg-10 col-lg-offset-1">
			...
			<div class="panel panel-default">
                ...
                <div class="panel-body">
					<form class="form-horizontal" role="form" method="GET" action="{{ URL::to('/listaesperas/resultadornle') }}">
						{{ csrf_field() }}
						...
						<div class="form-group">
							<label for="fecha" class="col-md-4 control-label">Fecha Digitación Ingreso</label>
							<div class="col-md-2">
