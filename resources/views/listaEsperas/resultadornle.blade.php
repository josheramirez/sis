    ...
    <div class="row">
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">Reporte RNLE</div>
                <div class="panel-body">
                    {{ csrf_field() }}
					<div class="row">
						<div class="col-md-6">
							<form class="form-horizontal" role="form" method="GET" action="{{ URL::to('/listaesperas/excelrnle') }}">
								...
								<input type="hidden" name="optfechadigeg" id="optfechadigeg" value="{{$optfechadigeg}}">
								<input type="hidden" name="digegdesde" id="digegdesde" value="{{$digegdesde}}">
								<input type="hidden" name="digeghasta" id="digeghasta" value="{{$digeghasta}}">
								...
								<span class="label label-default">(Hasta 10000 registros)</span>
							</form>
						</div>
					</div>
					</br>
									...
									<tbody>
										@foreach($listaesperas as $listaespera)
											<tr>
												...
												@else
													{{ $listaespera->fecha_digitacion_egreso }}
												@endif
												</td>
												<td>
