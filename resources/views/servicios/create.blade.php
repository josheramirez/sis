    ...
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
			...
			<div class="panel panel-default">
                <div class="panel-heading">Crear Servicio de Salud</div>
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ URL::to('servicios') }}">
                        {{ csrf_field() }}
						<!--Campo Codigo-->
			...
			<!--FIN Panel Formulario Crear Servicios-->
        </div>
    </div>
</div>
@endsection
