        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
					...
					<div class="col-md-8">
						<br><br>
						<p>Bienvenido al Sistemas de <b>Lista de Espera</b></p>
						...
						<p>Ante alguna duda, consulta o sugerencia, contactenos al correo: <a href="mailto:soporte.degi@redsalud.gov.cl">soporte.degi@redsalud.gov.cl</a></p> 
					</div>						
                </div>
            </div>
        </div>
