...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'dbMaestra'=>[
            'driver' => 'mysql',
            'host' => env('MAESTRA_HOST', '127.0.0.1'),
            'port' => env('MAESTRA_PORT', '5432'),
            'database' => env('MAESTRA_DATABASE', 'forge'),
            'username' => env('MAESTRA_USERNAME', 'forge'),
            'password' => env('MAESTRA_PASSWORD', ''),
            'charset' => 'utf8',
            'prefix' => '',
            'schema' => 'public',
            'sslmode' => 'prefer',
